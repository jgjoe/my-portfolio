  ...
  projects: {
    ...
    featured: [
      ...
      },
      {
        ...
        results: [{ value: { ko: "공개 배포", en: "Public release" }, label: "ONEstore v2.0.0" }, { value: "Google Play", label: { ko: "비공개 테스트 출시", en: "closed test release" } }, { value: "107/107 · 65/65", label: { ko: "자동·실기기 테스트 통과", en: "automated · device checks passed" } }],
      ...
      },
      {
        ...
        details: [
          ...
          { label: { ko: "판단", en: "Decision" }, copy: { ko: "장치마다 데이터 형태가 달라 차량·차종·소모품·주행패턴·사용자 도메인으로 나누고 MongoDB 문서 모델로 구조화했습니다.", en: "Because device data shapes differed, I separated the backend into vehicle, model, consumable, driving-pattern, and user domains and structured them as MongoDB documents." } },
