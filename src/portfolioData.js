    ...
    featured: [
      {
        ...
        lead: { ko: "로컬 CSV/XES 이벤트 로그를 브라우저에서 직접 매핑·검증해 분석하고, 두 실제 업무 프로세스를 하나의 deterministic Core로 처리하도록 만든 Process Intelligence 워크벤치입니다.", en: "A local Process Intelligence workbench that imports, maps, validates, and analyzes CSV/XES event logs through one deterministic Core proven across two real business processes." },
        ...
        details: [
          ...
          { label: { ko: "검증", en: "Verification" }, copy: { ko: "두 실제 데이터셋에서 Python 190/190, Playwright 2/2, Direct Agent 12/12, MCP Agent 12/12, Direct/MCP 비교 22/22를 통과했고 mismatch·grounding violation·forbidden-action violation은 모두 0건이었습니다. 현재 브라우저 온보딩 human cohort는 실행하지 않았습니다.", en: "Across two real datasets, the canonical project passed Python 190/190, Playwright 2/2, Direct Agent 12/12, MCP Agent 12/12, and 22/22 Direct/MCP comparisons, with zero mismatches, grounding violations, or forbidden-action violations. The current browser-onboarding human cohort was not run." } },
        ...
        media: { type: "image", src: "/traceverity-overview.png", host: "github.com/jgjoe/TraceVerity", alt: { ko: "Dataset Workspace에서 BPIC12를 선택한 현재 TraceVerity Process Intelligence 워크벤치", en: "Current TraceVerity Process Intelligence workbench with BPIC12 selected in the Dataset Workspace" }, caption: { ko: "브라우저 온보딩과 deterministic Core 집계 분석을 보여주는 현재 로컬 제품 화면", en: "Current local product view showing browser onboarding and deterministic Core aggregate analysis" } },
      },
      {
