...
|---|---|
| **About** | 지원 방향과 일하는 방식 |
| **Key outcomes** | RAG 정량 개선, 릴리스 보류·재출시, 논문·수상, 검증 근거 공개 |
...
- RAG 1순위 정답률 **40% → 52%** — 직접 만든 60문항 평가셋 기준
...
- `public/jigwan-joe-portfolio-2026.pdf`는 별도 정적 파일이므로 웹 콘텐츠 변경 후 별도 동기화가 필요합니다.
