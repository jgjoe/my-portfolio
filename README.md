...
├── assets/            프로필 이미지
└── index.css
public/                프로젝트 이미지, 기존 정적 PDF, OG 이미지
```
...
- `public/jigwan-joe-portfolio-2026.pdf`는 과거 정적 산출물로 남아 있으나 현재 사이트에서는 링크하지 않습니다. 웹 콘텐츠와 독립적으로 재생성·검증하기 전에는 현재 포트폴리오 문서로 사용하지 않습니다.
